...
(cl:defmethod cl:initialize-instance :after ((m <pid_input>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pid_input)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name follow-msg:<pid_input> is deprecated: use follow-msg:pid_input instead.")))

(cl:ensure-generic-function 'pid_vel-val :lambda-list '(m))
(cl:defmethod pid_vel-val ((m <pid_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow-msg:pid_vel-val is deprecated.  Use follow-msg:pid_vel instead.")
  (pid_vel m))

(cl:ensure-generic-function 'pid_error-val :lambda-list '(m))
(cl:defmethod pid_error-val ((m <pid_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader follow-msg:pid_error-val is deprecated.  Use follow-msg:pid_error instead.")
  (pid_error m))
