...
ki = 0.0  # TODO
servo_offset = (
    0.0  # zero correction offset in case servo is misaligned and has a bias in turning.
)
prev_error = 0.0
error_sum = 0.0
angle = 0.0
...
min_speed = 10
max_speed = 20
min_error = 0  # replace with your actual value
max_error = 90  # replace with your actual value
